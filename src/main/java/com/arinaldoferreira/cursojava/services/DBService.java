...
import com.arinaldoferreira.cursojava.domain.PagamentoComBoleto;
import com.arinaldoferreira.cursojava.domain.PagamentoComCartao;
import com.arinaldoferreira.cursojava.domain.Pedido;
import com.arinaldoferreira.cursojava.domain.Produto;
import com.arinaldoferreira.cursojava.domain.enums.EstadoPagamento;
import com.arinaldoferreira.cursojava.domain.enums.Perfil;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "manadelver@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "manadelver2@gmail.com", "36378912388", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("27363325", "91838393"));
